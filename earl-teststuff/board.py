...
# Check if X is drawn
        if (self.board[column][row + 2] == symbol and  # right
            self.board[column + 2][row] == symbol and  # below
            self.board[column + 2][row + 2] == symbol and  # bottom right
                self.board[column + 1][row + 1] == symbol):  # middle
...
# Check for strikethrough
        ...
        if((midleft != 0 and midleft != symbol) and
                (midright != 0 and midright != symbol)):
            crossed = True
